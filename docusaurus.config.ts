...
const config: Config = {
  ...
  tagline: 'A comprehensive guide to physical AI, humanoid robotics, and advanced AI systems.',
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl:
            'https://github.com/RidaNaz/Physical-AI-Humanoid-Robotics-TextBook',
        },
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        {
          type: 'docSidebar',
          sidebarId: 'bookSidebar', // Use the new bookSidebar
          position: 'left',
          label: 'Book',
        },
        {
      ...
      links: [
        {
          ...
          items: [
            {
              label: 'Book',
              to: '/docs/intro', // This will be updated later
            },
          ],
        },
        {
